  ...
  return (
    <div className="container my-24 mx-auto md:px-6">
      <section className="mb-32 text-center">
        <h2 className="mb-12 text-3xl text-black font-bold">الفريق</h2>

        <div className="grid gap-x-6 gap-y-6 md:grid-cols-3 lg:gap-x-12">
          ...
          <div className="mb-6 lg:mb-0">
            <div className="block rounded-lg  shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-neutral-700">
              ...
              <div className="p-6">
                <h5 className="mb-4 text-lg font-bold text-white">
                  حسام علي محمد القرني
                </h5>
                <p className="mb-4 text-neutral-300">443114765</p>
                <ul className="mx-auto flex list-inside justify-center">
                  <a href="#!" className="px-2">
                    {/* <!-- GitHub --> */}
                    <svg
          ...
          <div className="mb-6 lg:mb-0">
            <div className="block rounded-lg  shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-neutral-700">
              ...
              <div className="p-6">
                <h5 className="mb-4 text-lg font-bold text-white">
                  عبدالرحمن صالح الشمراني
                </h5>
                <p className="mb-4 text-neutral-300">443116046</p>
                <ul className="mx-auto flex list-inside justify-center">
                  <a href="#!" className="px-2">
                    {/* <!-- GitHub --> */}
                    <svg
        ...
        <h1 className="text-4xl font-bold text-black mx-auto my-20">
          أسم المشرف/ عبدالمجيد مبارك الشمراني
        </h1>
      </section>
    </div>
  );
